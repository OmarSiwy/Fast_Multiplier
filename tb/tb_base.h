...
template <class Module> class Tb_Base {
  int time;
  int timeIncPerTick;
  Module *top;
...
public:
  ...
  virtual bool isDone() { return this->ctx->gotFinish(); }

  int getTime() { return time; }

  Module *getTop(void) { return this->top; }

  VerilatedContext *getCtx(void) { return this->ctx; }
};
